...
namespace SteponTech.Services.BaseServices
{
    public class ModelsService : ServiceContract<SteponContext>
    {
        ...
        {
            return _context.ModelsEnglish.OrderByDescending(x => x.LastUpdate).ToList();
        }
        /// <summary>
        /// 根据ID获取板块信息
        /// </summary>
        ...
        {
            return _context.ModelsEnglish.FirstOrDefault(e => e.Id == id);
        }
        /// <summary>
        /// 根据板块名称获取板块信息
        /// </summary>
        ...
        {
            return _context.ModelsEnglish.FirstOrDefault(e => e.ModelName == modelName);
        }
        /// <summary>
        /// 获取所有要显示的板块信息
        /// </summary>
        ...
        {
            return _context.ModelsEnglish.Where(e => e.IsShow).OrderBy(e => e.CreationDate).ToList();
        }
        /// <summary>
        /// 增加板块
        /// </summary>
