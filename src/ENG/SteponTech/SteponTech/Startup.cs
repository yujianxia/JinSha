...
namespace SteponTech
{
    public class Startup
    {
        ...
        public void ConfigureBasic(IServiceCollection services)
        {
            ...
            //    config.UseActivator(new AspNetCoreJobActivator(services.BuildServiceProvider().GetService<IServiceScopeFactory>()));
            //});
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    "areaRoute",
                    "{area:exists}/{controller=JinSha}/{action=Index}/{id?}");

                routes.MapRoute(
                    "default",
                    "{controller=JinSha}/{action=Index}/{id?}");
            });
