...
namespace SteponTech.ApiControllers
{
    ...
    /// 登录API
    /// </summary>
    //谷歌调试有自动记住 如果Authorize无效 应该是这个问题 换个浏览器看看
    ...
    public class LoginAuthorizeController : BaseController<LoginAuthorizeController, SteponContext, ApplicationUser, IdentityRole>
    {
        ...
        [HttpGet("[action]")]
        public async Task<dynamic> zxczxcxzczc()
        {
            var filepath = Environment.WebRootPath;  //文件存储路径
            filepath = System.IO.Path.Combine(filepath, "upload\\Information\\3c078650-d276-4f70-84dd-ec951651ff3d");
            Utils.ImageControl.ImageControl ic = new Utils.ImageControl.ImageControl();
            ic.resizeImage("32a3fb25dfaefc9783d575829f213ded.jpg", filepath, 1366, 768);
            return Json(new { });
        }
        ...
        {
            var dataqqq = Context.InformationAll.Where(x => x.ColumName == "金沙快讯" || x.ColumName == "文化创作" || x.ColumName == "文创作品" || x.ColumName == "陈列馆" || x.ColumName == "巡回展览" || x.ColumName == "特展" || x.ColumName == "金沙太阳节" || x.ColumName == "讲座预告" || x.ColumName == "国际文化交流" || x.ColumName == "金沙十年" || x.ColumName == "国际博物馆日" || x.ColumName == "文化遗产日" || x.ColumName == "系列文化活动" || x.ColumName == "壁纸" || x.ColumName == "票务服务" || x.ColumName == "讲解服务" || x.ColumName == "餐饮服务" || x.ColumName == "金沙公告" || x.ColumName == "活动资讯");
