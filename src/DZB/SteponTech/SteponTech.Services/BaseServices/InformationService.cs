...
namespace SteponTech.Services.BaseServices
{
    public class InformationService : ServiceContract<SteponContext>
    {
        ...
        {
            return _context.Information.FirstOrDefault(e => e.Id == id);
        }
        /// <summary>
        /// 增加链接
        /// </summary>
        ...
        /// 修改链接
        /// </summary>
        public OperationResult ModifyInformation(Information Information)
        {
            var result = new OperationResult();
        ...
        {
            return _context.Information.Where(e => e.ColumnId == columnId).OrderBy(e => e.CreationDate).ToList();
        }
        /// <summary>
        /// 根据栏目Id获取资讯信息
        /// </summary>
        ...
        {
            return _context.Information.Where(e => ids.Contains(e.ColumnId)).OrderBy(e => e.CreationDate).ToList();
        }
        /// <summary>
        /// 根据栏目名称获取资讯信息
        /// </summary>
        ...
        {
            return _context.InformationAll.FirstOrDefault(e => e.ColumName == columName);
        }
    }
}
